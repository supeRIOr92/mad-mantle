// mappings/pool.ts — Pool/Pair swap handlers
// Handles: AgniPool.Swap + FluxionPool.Swap + MoeLBPair.Swap
...
function updateBucket(poolId: string, dex: string, timestamp: BigInt, amountUSD: BigDecimal): void {
