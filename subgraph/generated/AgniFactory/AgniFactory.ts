...
export class AgniFactory__collectProtocolResult {
  value0: BigInt;
  value1: BigInt;
...
export class AgniFactory__feeAmountTickSpacingExtraInfoResult {
  value0: boolean;
  value1: boolean;
...
export class AgniFactory extends ethereum.SmartContract {
  static bind(address: Address): AgniFactory {
    return new AgniFactory("AgniFactory", address);
  }
  ...
  collectProtocol(
  ...
  ): AgniFactory__collectProtocolResult {
    ...
    return new AgniFactory__collectProtocolResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
    );
  }
  ...
  try_collectProtocol(
    ...
    amount0Requested: BigInt,
    amount1Requested: BigInt,
  ): ethereum.CallResult<AgniFactory__collectProtocolResult> {
    ...
    return ethereum.CallResult.fromValue(
      new AgniFactory__collectProtocolResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
      ),
    );
  ...
  feeAmountTickSpacingExtraInfo(
    param0: i32,
  ): AgniFactory__feeAmountTickSpacingExtraInfoResult {
    let result = super.call(
      "feeAmountTickSpacingExtraInfo",
    ...
    return new AgniFactory__feeAmountTickSpacingExtraInfoResult(
      result[0].toBoolean(),
      result[1].toBoolean(),
    );
  }
  ...
  try_feeAmountTickSpacingExtraInfo(
    param0: i32,
  ): ethereum.CallResult<AgniFactory__feeAmountTickSpacingExtraInfoResult> {
    let result = super.tryCall(
      "feeAmountTickSpacingExtraInfo",
      "feeAmountTickSpacingExtraInfo(uint24):(bool,bool)",
      [ethereum.Value.fromUnsignedBigInt(BigInt.fromI32(param0))],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new AgniFactory__feeAmountTickSpacingExtraInfoResult(
        value[0].toBoolean(),
        value[1].toBoolean(),
      ),
    );
