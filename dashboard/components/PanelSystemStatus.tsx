...
const lastScanLabel = secondsAgo === null
? "No scans yet"
: secondsAgo < 60
? `${secondsAgo}s ago`
...
<span className={`w-3 h-3 rounded-full inline-block ${hasAlert ? "bg-red-500" : "bg-green-500"}`} />
<span className={`text-sm font-bold ${hasAlert ? "text-red-400" : "text-green-400"}`}>
